...
if (isset($_POST['confirm'])){
    ...
    if (empty($condition)){
        ...
        if( $isValidfirstName && $isValidlastName && $isValidemail && $isValidpwd && $isValidinfo)
        {
            ...
            $sql = "INSERT INTO users(firstName,lastName,password,email,info)VALUES('$firstName','$lastName','$password','$email','$info')"; 
            $base -> query($sql);
        }
        else{
        echo '<script type="text/javascript">';
...
?>
 ...
 <h2> S'inscrire </h2> <br>
    ...
    <div class="form-group">
        <label for="ipassword"> Confirmation :</label>
